...
use Rutatiina\GoodsReceived\Traits\InventoryReverse as TxnTraitsInventoryReverse;
...
class Update
{
    ...
    public function run()
    {
        ...
        $Txn = GoodsReceived::with('items', 'ledgers', 'debit_account', 'credit_account')->find($this->txn['id']);
        ...
        {
            $this->errors[] = 'Approved goods received note cannot be not be edited';
            return false;
        }
        ...
        try
        {
            ...
            {
                $ledger['goods_received_id'] = $txnId;
