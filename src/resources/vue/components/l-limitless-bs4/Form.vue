            ...
            <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
                <div class="d-flex">
                    <div class="breadcrumb">
                        ...
                        <span class="breadcrumb-item">Goods Received Note</span>
                    ...
                    <form v-if="!this.$root.loading"
                        ...
                        <fieldset class="">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-3">
                                    <input type="text" name="number" v-model="txnAttributes.number" class="form-control input-roundless" placeholder="Offer number">
                                </div>
                            ...
                            <div class="form-group row">
                                <table class="table table-bordered border-left-0 border-right-0 border-bottom-0">
                                    <thead class="thead-default bg-light">
                                        <tr>
                                            <th width="63%" class="font-weight-bold">Item / description</th>
...
<script>
    ...
    export default {
        name: 'AccoutingSalesRetainerInvoicesForm',
        components: {
        ...
        created: function () {
            this.pageTitle = 'Create Credit Note'
